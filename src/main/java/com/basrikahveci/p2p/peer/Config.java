...
public class Config {
    ...
    /**
     * Determine if node is in a withdraw state or a seeding state
     */
    private int withDrawFlag;
    
    /**
     * Determine if node is timed out
     */
    ...
    public void setWithdrawFlag(int flag){
    	this.withDrawFlag = flag;
    }
    
    public void setTimeoutFlag(int flag){
